...
const Intro = () => {
  return (
    <div className='flex relative overflow-hidden md:flex-row flex-col-reverse items-center justify-center md:justify-between mx-auto my-0 mt-20 w-[80%] z-40'>
      <div className="flex flex-col gap-5 text">
        <h1 className='max-w-[600px] font-semibold text-5xl leading-snug'>Bring everyone together to build better products.</h1>
      ...
      <div className="image">
        <img src={media.illustrationIntro} className='w-[700px]' alt="" />
      </div>
    </div>
  )
}
